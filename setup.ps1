...
Write-Host ""
Write-Host "  Admin bootstrap note:"
Write-Host "  - Before the first user exists, /admin accepts the admin password."
Write-Host "  - After a user exists, sign in to RedSecTools first, then use /admin."
Write-Host ""
