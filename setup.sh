...
echo ""
echo "  Admin bootstrap note:"
echo "  - Before the first user exists, /admin accepts the admin password."
echo "  - After a user exists, sign in to RedSecTools first, then use /admin."
echo ""
